...
//SYSPRINT DD  SYSOUT=*
//SYSUT2   DD  DSN=QUEUE.ASM,DISP=(NEW,CATLG),
//             UNIT=3350,SPACE=(CYL,(10,5,20)),
//             DCB=(RECFM=FB,LRECL=80,BLKSIZE=19040)
//OBJECT   DD  DSN=QUEUE.OBJ,DISP=(NEW,CATLG),
...
//QUEUEINS JOB (QUEUE),G.PRICE,CLASS=A,MSGCLASS=A,REGION=3072K,
//             COND=(0,NE),USER=IBMUSER,PASSWORD=SYS1
/*JOBPARM L=65
//ASMLQUE PROC M=MISSING,SP='NOSP,NODEBUG',TEST=NOTEST
//ASM     EXEC PGM=IFOX00,
//             PARM='DECK,NOLOAD,TERM,&TEST,SYSPARM((&SP))'
//SYSLIB   DD  DISP=SHR,DSN=QUEUE.ASM
...
//SYSTERM  DD  SYSOUT=*
//SYSPRINT DD  SYSOUT=*
//SYSIN    DD  DISP=SHR,DSN=QUEUE.ASM(&M)
//SYSPUNCH DD  DISP=SHR,DSN=QUEUE.OBJ(&M)
//        PEND
...
//SYSPRINT DD  SYSOUT=*
//SYSLIB   DD  DISP=SHR,DSN=QUEUE.OBJ
//SYSLIN   DD  *
